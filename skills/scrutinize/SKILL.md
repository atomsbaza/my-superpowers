...
> If your trace found no structural blocker or simpler alternative, see **Agent Integrations** below before writing Step 4.
...
If Steps 2–3 found no structural blocker or simpler alternative, spawn `code-reviewer` and `silent-failure-hunter` **in parallel** before writing Step 4. Give each the diff/plan and your one-sentence intent from Step 1.

Complete and seal your own Steps 2–3 notes **before** reading subagent output. Do not let their framing overwrite your independent trace — fold their findings into Step 4 as additional evidence, not as replacements for your own.
