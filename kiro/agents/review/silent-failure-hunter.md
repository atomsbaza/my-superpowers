...
When silent-failure bugs you find are fixed and validated, invoke the `/post-mortem` skill to document the mechanism and how it slipped through — this prevents the same class of bug from escaping again.
