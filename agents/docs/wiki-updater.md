...
- **Bug fixes documented** — after invoking `post-mortem` skill on a significant fix, reference it in the Gotchas or Implementation Progress section so the wiki captures how the bug slipped through and what prevents it in the future
