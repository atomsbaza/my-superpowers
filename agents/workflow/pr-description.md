...
- **For bug fix PRs:** if the bug is significant, the PR description should reference the `/post-mortem` documentation (written separately) so reviewers understand the root cause and how it slipped through
